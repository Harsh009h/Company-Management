...
public class EmployeeRepository {
    ...
    public List<Employee> getStudents() {
        ...
        jdbcTemplate.query(GET_ALL_STUDENTS, new RowMapper<Employee>() {
            @Override
    ...
    public boolean createStudent(Employee student){
    ...
    public Employee getStudentByRollNo(String bookName) {
        Employee student = new Employee();
        jdbcTemplate.query(GET_STUDENT_BY_ROLL_NO, new RowMapper<Employee>() {
            @Override
            public Employee mapRow(ResultSet rs, int rowNum) throws SQLException {
                student.setId(rs.getInt("id"));
                student.setAddress(rs.getString("address"));
    ...
    public int updateStudent(Employee student) {
